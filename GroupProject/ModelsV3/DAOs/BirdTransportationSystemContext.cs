...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BirdId).HasName("PK__Bird__7694332EF0B0507C");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Birds)
                ...
                .HasConstraintName("FK__Bird__CustomerID__3B75D760");
        });

        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B8FC362D0F");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BAFC39A8876");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30CFE4F87A3");
            ...
            entity.HasOne(d => d.Bird).WithMany(p => p.OrderDetails)
                ...
                .HasConstraintName("FK__OrderDeta__BirdI__3F466844");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__9B556A58E8E22073");
        ...
        {
            entity.HasKey(e => e.RouteId).HasName("PK__Route__80979AAD024AE608");
        ...
        {
            entity.HasKey(e => e.ShipperId).HasName("PK__Shipper__1F8AFFB91B1B91DC");
        ...
        {
            entity.HasKey(e => e.TrackingOrderId).HasName("PK__Tracking__24D0CD62902B7D73");
        ...
        {
            entity.HasKey(e => e.WarehouseId).HasName("PK__Warehous__2608AFD9CBB1BB96");
        ...
        {
            entity.HasKey(e => e.WarehouseManagerId).HasName("PK__Warehous__678D8266B1C25B05");
